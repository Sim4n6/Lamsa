...
def home(request):
    latest_recipes = Recette.objects.order_by()[:4]
    latest_travail_manuel = Travail_manuel.objects.order_by()[:4]
    latest_activite = Activite.objects.order_by()[:4]
...
def travaux(request):
    travaux = Travail_manuel.objects.all()
